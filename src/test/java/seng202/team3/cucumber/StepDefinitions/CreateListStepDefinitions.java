...
public class CreateListStepDefinitions {
    ...
    private UserWineList createdList;
    ...
    public void theWineDrinkerIsOnTheProfileScreen() {
        ...
        currentLists = wineListManager.getAllUserWineLists();
    ...
    public void createListButtonClicked() {
        createdList = wineListManager.newList(mockListNameTextField, mockDescriptionTextField);
    }
